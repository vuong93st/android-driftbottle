...
import com.douya.android.bottle.activity.home.HomeBottleListItemAdapter;
...
public class HyzyBottleActivity extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.hyzybottle);
		...
		if(bottleCount == 0){
			...
			BottleItem myItem = new BottleItem(0, "漠漠然的标签瓶","装有3个标签", BottleIcon.TAG_BOTTLE_ICON,BottleType.TAG_BOTTLE,
					"今天");
			list.add(myItem);
			myItem = new BottleItem(1, "漠漠然的祝愿瓶","愿天下所有父母健康长寿", 
					BottleIcon.WISH_BOTTLE_ICON,BottleType.WISH_BOTTLE,
					"昨天");
			list.add(myItem);
			myItem = new BottleItem(2, "漠漠然的传递瓶","春妮你在哪里？", BottleIcon.TRANSFER_BOTTLE_ICON,BottleType.TRANSFER_BOTTLE,
					"前天");
			list.add(myItem);
			myItem = new BottleItem(3, "漠漠然的同城瓶","谁在我附近，一起去K歌去？", BottleIcon.SAME_CITY_BOTTLE_ICON,BottleType.SAME_CITY_BOTTLE,
					"3天以前");
			list.add(myItem);
